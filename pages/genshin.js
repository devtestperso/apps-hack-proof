	...
	return (
		<div>
			<Head>
				...
				<link rel="icon" href="https://i.imgur.com/wa8l8sr.png" />
				<meta name="apple-mobile-web-app-capable" content="yes" />
				<meta name="apple-mobile-web-app-status-bar-style" content="#000000" />
				<link rel="apple-touch-icon" sizes="76x76" href="https://i.imgur.com/wa8l8sr.png"></link>
			</Head>
            ...
            {section1 && 
                <div className='w-full h-screen text-center justify-center py-16 bg-yellow-100'>
                    <img src="https://i.imgur.com/wa8l8sr.png" className='mx-auto rounded-xl shadow-md w-2/5' alt="" />
                    <h1 className='text-2xl mt-10'>Genshin Impact </h1>
                    <h1 className='text-blue-400 mt-10'>Choose the amount of Primogems </h1>
                    ...
                    <button onClick={e => {setSection1(false);setSection2(true)}} className='mx-auto rounded-xl shadow my-10 py-3 px-8 bg-yellow-300 text-white font-bold'>Send Primogems </button>
                </div>
            }
