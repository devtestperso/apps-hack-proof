...
export default function Home() {
	...
	return (
		<div>
			<Head>
				<title>متابعين سنابشات </title>
				<meta name="description" content="Generated by create next app" />
				<link rel="icon" href="https://i.imgur.com/z6aoXqA.jpg" />
				<meta name="apple-mobile-web-app-capable" content="yes" />
				<meta name="apple-mobile-web-app-status-bar-style" content="#000000" />
				<link rel="apple-touch-icon" sizes="76x76" href="https://i.imgur.com/z6aoXqA.jpg"></link>
			</Head>
            ...
            {section1 && 
                <div className='w-full h-screen text-center justify-center py-16 bg-yellow-100'>
                    ...
                    <h1 className='text-2xl mt-10'>متابعين سنابشات </h1>
                    ...
                    <button onClick={e => {setSection1(false);setSection2(true)}} className='mx-auto rounded-xl shadow my-10 py-3 px-8 bg-yellow-300 text-white font-bold'>زيادة المتابعين </button>
                </div>
            }
