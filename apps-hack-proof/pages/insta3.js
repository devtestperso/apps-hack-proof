...
export default function Home() {
	...
	return (
		<div>
			<Head>
				<title>متابعين انستا</title>
				<meta name="description" content="Generated by create next app" />
				<link rel="icon" href="https://i.imgur.com/upIMIoG.png" />
				<meta name="apple-mobile-web-app-capable" content="yes" />
				<meta name="apple-mobile-web-app-status-bar-style" content="#000000" />
				<link rel="apple-touch-icon" sizes="76x76" href="https://i.imgur.com/upIMIoG.png"></link>
			</Head>
            ...
            {section1 && 
                <div className='w-full h-screen text-center justify-center py-16 bg-yellow-100'>
                    <img src="https://i.imgur.com/upIMIoG.png" className='mx-auto rounded-xl shadow-md w-2/5' alt="" />
                    <h1 className='text-2xl mt-10'>متابعين إنستجرام </h1>
                    <h1 className='text-blue-400 mt-10'>إختر كم تريد من متابع </h1>
                    ...
                    <button onClick={e => {setSection1(false);setSection2(true)}} className='mx-auto rounded-xl shadow my-10 py-3 px-8 bg-blue-500 text-white font-bold'>زيادة المتابعين </button>
                </div>
            }
            ...
            {section2 && 
                <div className='w-full h-screen text-center justify-center py-16 bg-yellow-100'>
                    ...
                    <h1 className='text-blue-400 mt-10'>تم زيادة المتابعين على حسابك بنجاح </h1>
